...
const tableData = {
    ...
    'SF': { name: '新婦親族', guests: [{name:'磯貝公紀様',x:'25%',y:'38%'}, {name:'磯貝信子様',x:'30%',y:'36%'}, {name:'磯貝ひかる様',x:'30%',y:'36%'}, {name:'オーグスティーンジャクセン様',x:'30%',y:'36%'}, {name:'オーグスティーン桃花様',x:'30%',y:'36%'}, {name:'磯貝美和子様',x:'30%',y:'36%'}, 
