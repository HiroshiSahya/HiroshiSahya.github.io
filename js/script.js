...
const tableData = {
    ...
    'SA': { name: '新婦会社', guests: [{name:'中村裕仁様',x:'64%',y:'16.2%'}, {name:'澤村美紀様',x:'69%',y:'18%'}, {name:'上松啓介様',x:'72%',y:'21.5%'}, {name:'梅田章仁様',x:'72%',y:'27.9%'}, {name:'川上貴弘様',x:'69%',y:'31.4%'}, {name:'神山連様',x:'64%',y:'33.2%'}, {name:'山口史乃様',x:'59%',y:'31.4%'}, {name:'太田和洋様',x:'56%',y:'27.9%'}, 
