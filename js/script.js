...
// エスコートカードのデータ例
const tableData = {
    'HA': { name: '新郎研究室', guests: [{name:'関根泰様',x:'36.2%',y:'16.6%'}, {name:'七種紘規様',x:'44.4%',y:'24.6%'}, {name:'渡辺光亮様',x:'36%',y:'32.9%'}, {name:'手塚玄惟様',x:'27.8%',y:'24.3%'}], positions: [{x: '36%', y: '24.7%' }]},
    ...
    'HD': { name: '新郎親族', guests: [{name:'久我成子様',x:'26.6%',y:'61.9%'}, {name:'近藤紀子様',x:'32.5%',y:'64.4%'}, {name:'近藤純一様',x:'34.8%',y:'70%'}, {name:'近藤克輝様',x:'32.5%',y:'75.6%'}, {name:'近藤智美様',x:'26.6%',y:'78.1%'}, {name:'近藤慧史様',x:'20.5%',y:'75.6%'}, {name:'平田文子様',x:'18.4%',y:'70%'}, 
                                      {name:'倉島聰子様',x:'20.5%',y:'64.4%'}, {name:'三瓶公子様',x:'36.1%',y:'77.2%'}, {name:'三瓶純志様',x:'43.5%',y:'81%'}, {name:'三瓶尚志様',x:'43.5%',y:'89%'}, {name:'三瓶純子様',x:'36.3%',y:'93.2%'}, {name:'田川美智子様',x:'29.1%',y:'89%'}, {name:'田川行雄様',x:'29.1%',y:'81%'}], positions: [{x: '26.6%', y: '70%' }, {x: '36.3%', y: '85%' }]},
    'SA': { name: '新婦会社', guests: [{name:'中村裕仁様',x:'64%',y:'16.6%'}, {name:'澤村美紀様',x:'69%',y:'18.2%'}, {name:'上松啓介様',x:'71.4%',y:'21.9%'}, {name:'梅田章仁様',x:'71.4%',y:'26.9%'}, {name:'川上貴弘様',x:'69%',y:'31.0%'}, {name:'神山連様',x:'64%',y:'33.2%'}, {name:'山口史乃様',x:'59%',y:'31.0%'}, {name:'太田和洋様',x:'56.6%',y:'26.9%'}, 
                                      {name:'高島史郎様',x:'56.6%',y:'21.9%'}, {name:'相輪歩様',x:'59%',y:'18.2%'}, {name:'高岡颯良様',x:'50%',y:'31.7%'}, {name:'野口聖七様',x:'57.1%',y:'35.6%'}, {name:'小倉有里加様',x:'57.1%',y:'43.6%'}, {name:'小林歩様',x:'50%',y:'47.7%'}, {name:'土田太一様',x:'43.1%',y:'43.6%'}, {name:'岸下竜士様',x:'43.1%',y:'35.6%'}], positions: [{x: '64%', y: '24.7%' }, {x: '50%', y: '39.6%' }]},
    ...
    'SD': { name: '新婦サークルここから', guests: [{name:'丸山千晴様',x:'62.2%',y:'46.3%'}, {name:'上松剛己様',x:'68.7%',y:'49.2%'}, {name:'三吉野節様',x:'70.7%',y:'54.8%'}, {name:'木谷勇稀様',x:'68.7%',y:'60.4%'}, {name:'中村洋輝様',x:'62.2%',y:'63.3%'}, {name:'中村あいり様',x:'55.7%',y:'60.4%'}, {name:'藤澤みづき様',x:'53.7%',y:'54.8%'}, {name:'清水美羽様',x:'55.7%',y:'49.2%'}], positions: [{x: '62.2%', y: '54.8%' }]},
